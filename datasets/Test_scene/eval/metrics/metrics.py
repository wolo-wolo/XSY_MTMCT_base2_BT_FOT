    ...
    def accumulate(self):
        if len(self.results['bbox']) > 0:
            ...
            with open(output, 'w') as f:
                ...
                logger.info('The bbox test_results is saved to bbox.json.')

            if self.save_prediction_only:
                logger.info('The bbox test_results is saved to {} and do not '
        ...
        if len(self.results['mask']) > 0:
            ...
            with open(output, 'w') as f:
                ...
                logger.info('The mask test_results is saved to mask.json.')

            if self.save_prediction_only:
                logger.info('The mask test_results is saved to {} and do not '
                            'evaluate the mAP.'.format(output))
            else:
        ...
        if len(self.results['segm']) > 0:
            ...
            with open(output, 'w') as f:
                ...
                logger.info('The segm test_results is saved to segm.json.')

            if self.save_prediction_only:
                logger.info('The segm test_results is saved to {} and do not '
                            'evaluate the mAP.'.format(output))
            else:
                seg_stats = cocoapi_eval(
                    output,
        ...
        if len(self.results['keypoint']) > 0:
            ...
            with open(output, 'w') as f:
                ...
                logger.info('The keypoint test_results is saved to keypoint.json.')

            if self.save_prediction_only:
                logger.info('The keypoint test_results is saved to {} and do not '
                            'evaluate the mAP.'.format(output))
            else:
                style = 'keypoints'
                use_area = True
