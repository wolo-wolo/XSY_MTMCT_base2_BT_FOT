...
def prepare_cluster_inputs(costs: dict, speeds: dict):
    ...
    for tid in tc_cost_speed.keys():
        ...
        for i in range(num_tracklet):
            tvec = np.zeros((13), dtype=np.float64)  # vtec is the best!!!
...
if __name__ == "__main__":
    ...
    if USE_ROI:
        roi_dir = os.path.join(cfg.CHALLENGE_DATA_DIR, 'S04')
    ...
    * 单一镜头轨迹
    ...
    # tracklets: 87
    # speed
    # outliers: {2: [1], 31: [1], 34: [2, 3], 60: [3]}
    # direction
    # outliers: {}
    # []
    # traj
    # len
    # outliers: {4: {1: 7}, 8: {1: 5, 6: 4}, 14: {1: 2, 5: 2, 6: 2}, 18: {1: 7, 5: 9}, 27: {6: 9}, 31: {5: 3}, 39: {2: 5},
    #            35: {2: 9}, 46: {3: 4, 4: 2}, 52: {3: 4}, 54: {3: 2, 5: 2}, 60: {4: 2}, 85: {6: 5}, 86: {5: 4, 6: 5}}
    # 35 - 2
    # cannot
    # find
    # candidate
