...
def gather_sequence_info(sequence_dir, detection_file, max_frame):
    ...
    # image_filenames: {...,
    # '005592': '/home/ubuntu/wgj/AIC21-MTMC/AIC21-MTMC-HW/datasets/detection/images/test/S06/c002/img1/img005592.jpg', ...}
    ...
    for image_name in det_feat_dic:
        ...
        # save bbox/feat to dict based on frameID
...
def run(sequence_dir, detection_file, output_file, min_confidence,
    ...
    def frame_callback(vis, frame_idx):
        ...
        # Update tracker. reserve det > conf_threshold,
        online_targets = tracker.update(detections, feats, frame_idx)
        # Store results.
        for t in online_targets:
            tlwh = t.det_tlwh  # tlwh代表左上角坐标+宽高 tlbr: 代表左上角坐标+右下角坐标
            tid = t.track_id
            score = t.score
            # feature = t.smooth_feat
            feature = t.features[-1]
            # vertical = tlwh[2] / tlwh[3] > 1.6
            feature = t.smooth_feat  # 2048-d array
...
if __name__ == "__main__":
    ...
    cfg.freeze()
    # original det img sequence: datasst/detection/test/S06/c00X/
